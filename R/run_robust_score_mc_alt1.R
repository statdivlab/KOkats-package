...
#' }
#' 
#' res <- run_robust_score_mc_alt1(Y = Y, X = X, ncores = 2, null_k = 2, null_j = 2)
#' 
#' @export
run_robust_score_mc_alt1 <- function(formula_rhs = NULL,
                                    Y,
                                    X = NULL,
                                    covariate_data = NULL,
                                    B = NULL,
  ...
  scores <- compute_scores_mc(X, Y, B_mle, z_mle, constraint_cat)
